...
function Features(props) {
 ...
 <div className={classes.features}>
      <div>
        ...
        <Typography variant="h4" className={classes.text}>Nostalgia Therapy is a multimodal reminiscence therapy tool that provides a simple and effective way for 
        ...
        web application. Reminiscence therapy works by stimulating the brain with familiar images, sounds, and videos to spur conversations and unlock 
        memories.</Typography>
      </div>
